...
const initValue = {
    product : [
      ...
      },
      {
        ...
        date : "31/8/2022",
        imageSrc: 'https://cdn.galaxycine.vn/media/2022/7/29/1200x1800_1659069868525.jpg',
        description: "Bộ phim kể về chú chó tên Hank ước mơ trở thành samurai. Hank tới vùng đất của những chú mèo samurai với mong muốn cũng được trở thành samurai huyền thoại. Không may, vì âm mưu của Ika Chu, Hank bị đưa đến ngôi làng Kakamucho - một ngôi làng toàn mèo. Dĩ nhiên, mèo thì không thích chó. Hành trình để chinh phục sự yêu quý của làng Kakamucho và đạt được ước mơ của Hank từ đó bắt đầu. Phim mới Môn Phái Võ Mèo: Huyền Thoại Một Chú Chó khởi chiếu vào 01.09.2022 tại các rạp chiếu phim toàn quốc",
        price: '130.000',
        Age : 'C13'
      },
      {
...
export const {addToCart,deleteProDuct,deleteItemCart,searchFillterChange,getMovieDetail,getProDuct} = productSlice.actions
