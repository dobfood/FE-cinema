...
const Detail = () => {
    ...
    const [product, setProduct] = useSelector(item => item.movie.product)
        ...
        <>
            ...
            <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
                <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                    <img className="w-full" alt="img of a girl posing" src={product.imageSrc} />
                ...
                <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                    <div className="border-b border-gray-200 pb-6">
                        <p className="text-sm leading-none text-gray-600">{product.engname}</p>
                        <h1
                            className="
							lg:text-2xl
							text-xl
                    ...
                    <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                        <p className="text-base leading-4 text-gray-800">Thể loại : {product.category}</p>
                    </div>
                    <div>
                        <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7"> Hãng phim : {product.author}</p>
                    </div>

                    <div>
                        <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7">  Diễn viên : {product.cast}</p>
                    </div>

                    <div>
                        <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7">  Lịch khởi chiếu : {product.date}</p>
                    </div>

                    <div>
                        <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7">  Giá : {product.price}</p>
                    </div>
