  ...
  return (
    ...
    <div class="relative">
      ...
      <div className="max-w-screen-xl mx-auto p-4">
        <h1 className="text-5xl font-extrabold mb-4 text-center text-indigo-700">BLOG ĐIỆN ẢNH</h1>
        <div className="flex flex-col md:flex-row -mx-1.5 p-4">
          <a href="#" className="h-72 md:h-auto w-full md:w-7/12 mx-1.5 mb-6 md:mb-0 group">
            <div className="h-72 md:h-full relative">
              <img src="https://www.galaxycine.vn/media/2022/10/5/black-panther-wakanda-forever-boc-tach-trailer-moi-nhat-1_1664954237359.jpeg" className="absolute z-0 object-cover w-full h-72 md:h-full rounded-md" />
              ...
              <div className="absolute left-0 right-0 bottom-0 p-4 z-30">
                <h1 className="font-bold text-white leading-tight sm:mb-1.5 group-hover:underline text-2xl md:text-3xl">Black Panther Wakanda Forever: Bóc Tách Trailer Mới Nhất!</h1>
          ...
          <div className="w-full md:w-5/12 mx-1.5">
            <a href="#" className="flex items-center group mb-3 pb-3 border-b">
              <img src="https://www.galaxycine.vn/media/2022/8/29/may-ngung-quay--ho-van-dien--nhung-ngoi-sao-tan-tam-nhat-7_1661791947923.jpg" className="rounded-md object-cover mr-3 h-24 w-24" />
              <div className="flex-1">
                <h2 className="font-bold text-lg leading-tight group-hover:underline mb-2">Máy Ngừng Quay, Họ Vẫn Diễn – Những Ngôi Sao Tận Tâm Nhất!</h2>
                <div className="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="clock" className="h-3 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"></path>
                  </svg>
            ...
            <a href="#" className="flex items-center group mb-3 pb-3 border-b">
              <img src="https://www.galaxycine.vn/media/2022/8/29/vi-cuu-the-flash--ezra-miller-hua-se-ngoan-6_1661790089141.jpg" className="rounded-md object-cover mr-3 h-24 w-24" />
              <div className="flex-1">
                <h2 className="font-bold text-lg leading-tight group-hover:underline mb-2">Vì Cứu The Flash, Ezra Miller Hứa Sẽ Ngoan!</h2>
                <div className="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="clock" className="h-3 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"></path>
                  </svg>
            ...
            <a href="#" className="flex items-center group mb-3 pb-3 border-b">
              <img src="https://www.galaxycine.vn/media/2022/8/29/nope-khong-phai-mot-phim-kinh-di-de-hieu--3_1661781885960.jpg" className="rounded-md object-cover mr-3 h-24 w-24" />
              <div className="flex-1">
                <h2 className="font-bold text-lg leading-tight group-hover:underline mb-2">Nope: Không Phải Một Phim Kinh Dị Dễ Hiểu!</h2>
                <div className="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="clock" className="h-3 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"></path>
                  </svg>
            ...
            <a href="#" className="flex items-center group">
              <img src="https://www.galaxycine.vn/media/2022/8/25/avatar-da-thay-doi-nen-cong-nghiep-dien-anh-nhu-the-nao-5_1661393762674.jpg" className="rounded-md object-cover mr-3 h-24 w-24" />
              <div className="flex-1">
                <h2 className="font-bold text-lg leading-tight group-hover:underline mb-2">Avatar Đã Thay Đổi Nền Công Nghiệp Điện Ảnh Như Thế Nào?</h2>
                <div className="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="clock" className="h-3 mr-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"></path>
                  </svg>
